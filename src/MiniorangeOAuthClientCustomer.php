...
class MiniorangeOAuthClientCustomer {
  ...
  public function createCustomer() {
    ...
    $fields = array(
      ...
      'areaOfInterest' => 'DRUPAL ' . Utilities::mo_get_drupal_core_version() . ' OAuth Client',
      'email' => $this->email,
      'phone' => $this->phone,
  ...
  public function sendOtp() {
    ...
    $fields = array(
      ...
      'email' => $username,
      'authType' => 'EMAIL',
      'transactionName' => 'Drupal ' . Utilities::mo_get_drupal_core_version() . ' OAuth Client Module',
    );
    $field_string = json_encode($fields);
